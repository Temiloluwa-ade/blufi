...
const BigInput = ({
  ...
  return (
    <BigNameInputWrapper>
      <BigInputText>blufi.com/</BigInputText>
      <BigInputInput
        type="text"
...
const Home: NextPage = () => {
  ...
  return (
    <>
      <MetaTags title="Blufi" />
      <LandingSection>
        <CenterTitleBox>
          <MainHeading>Let your appreciators tip you in flow with blufi.</MainHeading>
          <Subtitle>
      ...
      >
        <Column>
          <SmallRedText>WHAT IS blufi?</SmallRedText>
          ...
          <NormalText>
            Wouldn’t it be nice if everyone, who appreciate your work tip you? Now they can! They are not your <s>customers</s>, they
      ...
      <Section bgcolor={theme.colors.secondary} color={theme.colors.white}>
        <BenefitLeftColumn>
          <SmallRedText>Tip me with flow.</SmallRedText>
          ...
          <NormalText style={{ color: "white" }}>
            ...
            for your project? Blufi was designed for amazing people who are
